...
class RecommendedRecipeDetailScreen extends StatefulWidget {
  ...
  const RecommendedRecipeDetailScreen({
    super.key,
    required this.recipeMatch,
  });

  @override
  State<RecommendedRecipeDetailScreen> createState() =>
      _RecommendedRecipeDetailScreenState();
}

class _RecommendedRecipeDetailScreenState
    extends State<RecommendedRecipeDetailScreen> {
